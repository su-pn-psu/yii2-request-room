...
/**
 * RoomReserveStaffIndexSearch represents the model behind the search form about `suPnPsu\reserveRoom\models\RoomReserve`.
 */
class RoomReserveStaffReturnedSearch extends RoomReserveSearch {
